		...
		it("should respect the excludes option", () => {
			return polyfillio.getPolyfills({
				...
				assert.deepEqual(setsToArrays(result), {
					...
					'_ESAbstract.CreateMethodProperty': {
						flags: [],
						aliasOf: ['Array.prototype.filter',
					...
					'_ESAbstract.ToPrimitive': {
						flags: [],
						aliasOf: ['Array.prototype.forEach', '_ESAbstract.ToString', 'fetch']
					},
					'_ESAbstract.Type': {
						flags: [],
						aliasOf: ['Array.prototype.filter',
					...
					_sharedKeys: {
						flags: [],
						aliasOf: ['Symbol', 'Symbol.iterator', 'fetch']
					},
					'Object.keys': {
						flags: [],
						aliasOf: ['Object.create',
							'Object.defineProperties',
							'Symbol',
							'Symbol.iterator',
							'fetch'
					...
					'_ESAbstract.OrdinaryToPrimitive': {
						flags: [],
						aliasOf: ['Array.prototype.forEach',
							'_ESAbstract.ToPrimitive',
							'_ESAbstract.ToString',
							'fetch'
						]
