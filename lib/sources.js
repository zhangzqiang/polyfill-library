...
const LRUCache = require('mnemonist/lru-cache').default;
...
const _aliases = (async function() {
  const aliases = await readFile(path.join(polyfillDirectory, "aliases.json"), {encoding: 'utf-8'});
 ...
 * @returns {import("graceful-fs").ReadStream} A ReadStream instance of the polyfill implementation as a utf-8 string.
 */
